...
local ci_project = prova.fixture("standards[rust-grpc/None]:project", Scope.File, function(ctx)
	return archetect.render{
		source = SRC,
		answers = {
			author_name = "Test Author",
...
prova.group("rust-grpc[None]:ci", { requires = { "docker" }, tags = { "standards" } }, function(g)
